...
- [2026-05-27] Monetization: **none**. App is fully free — no IAP, no subscriptions, no ads, no tips. The original consumable StoreKit 2 tip (€1.49 "Buy me a coffee") was built and then removed — the community-curated framing felt asymmetric next to contributor-supplied data. If support is ever needed, prefer an out-of-app channel (GitHub Sponsors) over reintroducing IAP.
